...
Utilize o método .sort() para ordenar as matrizes:

notas = notas.sort()

Utilize if/else para comparar os valores e eliminar o menor e maior;

Utilize o método .slice(x, y) para ajudar na seleção dos valores:

// Elimina a maior e a menor nota
let notasComputadas = notas.slice(1,4)

Utilize o método .forEach() para realizar a soma dos valores da média;

Utilize .length para saber o tamanho da matriz na hora do cálculo da média;

Utilize console.log() para mostrar o resultado para o usuário.
